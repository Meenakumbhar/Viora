...
export default function DesignReviewSubmit({ orderId, revisionId, images, labels, version, otherRevisions }: DesignReviewSubmitProps) {
  ...
  return (
    <div>
      <p className="mb-4 font-mono text-base uppercase tracking-widest text-text-muted">Proof v{version}</p>
      {error && (
        <p className="mb-4 font-mono text-base text-red-500" role="alert">
          {error}
        </p>
      )}
      <DesignReviewCanvas
