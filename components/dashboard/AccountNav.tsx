...
const NAV_ITEMS = [
  ...
  { href: '/account/spend', label: 'Payment analysis', exact: true },
      ...
      {NAV_ITEMS.map((item) => {
        ...
        return (
          <Link
            key={item.href}
            href={item.href}
            className={`shrink-0 whitespace-nowrap border-b-2 px-3 py-2.5 font-mono text-sm uppercase tracking-widest transition-colors lg:border-b-0 lg:border-l-2 lg:px-4 ${
              active
